...
$('#addPerson').click(function() {
    ...
    $('#person').append('<div class="form-group"><hr class="hr-double"><button type="button" class="btn btn-warning btn-xs" onclick="deletePerson(this)">删除</button><div class="clear-left"></div><div class="line-25-per"><label>相关成员姓名</label><input class="form-control" name="pName[]"><p class="help-block text-info">可选填</p> </div><div class="line-25-per"><label>备注</label><input class="form-control" name="pRemark[]"> <p class="help-block text-info">可选填</p></div><div class="line-25-per"><label>排名情况</label><input class="form-control" name="pOrder[]"> <p class="help-block text-info">可选填</p></div><div class="clear-left"></div></div><!-- /.form-group -->');
