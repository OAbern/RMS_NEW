...
<head>
	...
	$(function ()
	{
		$("#timePositionBegin").ligerDateEditor({ showTime: true, width: 132, label: '职务开始时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
		$("#timePositionEnd").ligerDateEditor({ showTime: true, width: 132, label: '职务结束时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
	});
	</script>
</head>
<body style="padding:0px;">
	<div id="allpage">
		<div class="content">
			<form action="managePositions.action" method="post">
				<label for="positionName">职务:</label>
				<input type="text" id="positionName" name="positionName" class=":required" />
				<br /><br />

				<label for="timePositionBegin"></label>
				<input type="text" id="timePositionBegin" name="timePositionBegin" />
				<br /><br />
				
				<label for="timePositionEnd"></label>
				<input type="text" id="timePositionEnd" name="timePositionEnd" />
				<br /><br />
				
				<label for="remarks">备注:</label>
				<input type="text" id="remarks" name="positions.remarks"class=":required" />
				<br /><br />
