// JavaScript Document
 ...
 var alert = function (content)
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                columns: [
                { display: '学院', name: 'College', align: 'left', width: 100, minWidth: 60 },
                { display: '老师', name: 'Teacher_Name', align: 'left', minWidth: 140 },
                { display: '项目名称', name: 'Project_Name', align: 'left', minWidth: 140 },
                { display: '项目编号', name: 'Project_ID', align: 'left', width: 100, minWidth: 60 },
                { display: '类型', name: 'Type', width: 120 },
                { display: '成果展示', name: 'Achievement', width: 60 },
