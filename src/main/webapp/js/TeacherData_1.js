// JavaScript Document
 ...
 var alert = function (content)
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                columns: [
                { display: '姓名', name: 'Teacher_Name', align: 'left', width: 120, minWidth: 60 },
                { display: '性别', name: 'Gender', align: 'left', minWidth: 80 },
                { display: '学历', name: 'Education', align: 'left', minWidth: 120 },
                { display: '职称', name: 'Title', align: 'left', minWidth: 120  },
                { display: '专业', name: 'Major', align: 'left', minWidth: 150  },
                { display: '团队设置', name: 'Group' , align: 'left', minWidth: 180 },
