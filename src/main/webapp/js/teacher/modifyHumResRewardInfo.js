...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#approveTime").ligerDateEditor({ showTime: true, width: 130, label: '获奖批准时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("approveTime").value});
