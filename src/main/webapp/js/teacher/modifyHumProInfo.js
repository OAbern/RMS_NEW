...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#timeApproved").ligerDateEditor({ showTime: true, width: 130, label: '批准时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("timeApproved").value});
