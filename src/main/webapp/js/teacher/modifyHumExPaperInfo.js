...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#publishedTime").ligerDateEditor({ showTime: true, width: 130, label: '发表时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("publishedTime").value});
