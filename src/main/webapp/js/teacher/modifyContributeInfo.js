...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#checkTime").ligerDateEditor({ showTime: true, width: 130, label: '年度检查时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("checkTime").value});
			$("#endTime").ligerDateEditor({ showTime: true, width: 130, label: '结题时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("endTime").value});
