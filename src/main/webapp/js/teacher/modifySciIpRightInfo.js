...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#filingDate").ligerDateEditor({ showTime: true, width: 130, label: '申请日期', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("filingDate").value});
			$("#announcementDate").ligerDateEditor({ showTime: true, width: 130, label: '授权公告日期', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("announcementDate").value});
