...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#startTime").ligerDateEditor({ showTime: true, width: 130, label: '转让技术研究的起始时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("startTime").value});
			$("#endTime").ligerDateEditor({ showTime: true, width: 130, label: '转让技术研究的终止时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("endTime").value});
