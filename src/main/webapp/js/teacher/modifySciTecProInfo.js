...
var xmlhttp;
        ...
        $(function ()
        {
            ...
            $("#timeProjectApproved").ligerDateEditor({ showTime: true, width: 130, label: '合同批准（合同签订）时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd", initValue: document.getElementById("timeProjectApproved").value});
