// JavaScript Document
 ...
 var alert = function (content)
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                columns: [
                { display: '旁证材料', name: 'Project_ID', align: 'left', width: 100, minWidth: 60 },
                { display: '名称', name: 'Group_Name', align: 'left', minWidth: 240 },
/*                { display: '项目名称', name: 'Project_Name', align: 'left', minWidth: 140 },
                { display: '上传时间', name: 'Submit_Time' },
                { display: '是否提交', name: 'Is_Submit' },
                { display: '评审状态', name: 'Status' },
                { display: '评审结果', name: 'Result' },
