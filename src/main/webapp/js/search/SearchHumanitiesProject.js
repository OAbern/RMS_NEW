 ...
 var alert = function (content)
        ...
        function showdata(){
            ...
            g = manager = $grid = $("#maingrid").ligerGrid({
                ...
                { display: '项目编号', name: 'projectNumber', align: 'left', width: 100, minWidth: 60 },
                { display: '项目来源', name: 'projectOrigin', align: 'left', width: 100, minWidth: 60 },
                { display: '批准时间', name: 'timeApproved', align: 'left', width: 100, minWidth: 60 },
        ...
        function getInfo(){
        	...
        	$.ajax({
        		type:"POST",
        		url:"searchCollegeHumanitiesProjectInfo.action",
        		datatype:"script",
        ...
        function callback(builder){
        	...
        	for(var objid in callbackdate){
        		var projectInfos = callbackdate[objid];		
        		var row = {projectId: projectInfos.projectId,
        				projectName: projectInfos.projectName,
        				projectNumber: projectInfos.projectNumber, 
        				projectOrigin:projectInfos.projectOrigin, 
        				timeApproved:projectInfos.timeApproved,
        				submitUser:projectInfos.submitUser,
        				approvedUser:projectInfos.approvedUser,
