...
insert  into `research_class`(`class_id`,`class_name`,`class_des`,`class_remark`,`is_delete`,`order`,`submittime`,`parent_id`) values (15,'二级测试','','',0,NULL,'2016-04-24 12:53:05',12);
...
CREATE TABLE `research_person` (
  ...
  `orders` int(11) DEFAULT NULL COMMENT '排名',
...
insert  into `role_purview_dynamic`(`id`,`role_id`,`class_id`,`input`,`manage`,`approve`,`statistics`) values (4,1,15,1,0,0,0);
